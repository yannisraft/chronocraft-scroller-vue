...
<div style="padding: 20px; display: flex; height: 500px">
    ...
    <div style="width: 50%">
        <!-- Infinite -->
        <VScroller v-model="scrollerdata" :isInfinite="true" :scrollSpeed="3" :sidegap="3" :cellWidth="50" :hasScrollbar="true" orientation="vertical" :numberOfRows="5" @on-initilized="onInitialized" @on-update-data-next="onUpdateDataNext" @on-update-data-previous="onUpdateDataPrevious">
        </VScroller>
